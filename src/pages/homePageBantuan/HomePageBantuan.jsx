...
import HeaderComponent from "../homePage/headerComponent/HeaderComponent";
import FooterComponent from "../homePage/footerComponent/FooterComponent";

const HomePageBantuan = () => {
  return (
    <div className="homepageBantuan">
      <HeaderComponent />
      <div className="homepage-bantuan-pages2">
        ...
        <h2 className="tentang-teks">
          Buka aplikasi Playstore atau App Store <br /> Cari aplikasi
          “Complainz”, lalu unduh Setelah berhasil diunduh, <br /> buat akun
          dengan mengisi data registrasi Setelah melakukan registrasi <br />
